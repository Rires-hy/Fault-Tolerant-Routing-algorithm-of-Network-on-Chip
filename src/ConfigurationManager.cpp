...
void loadConfiguration() {
    ...
    GlobalParams::my_topology = readParam<int>(config,"my_topology",0);
    GlobalParams::topology = readParam<string>(config, "topology", TOPOLOGY_MESH);
    GlobalParams::package_injected=0;
    GlobalParams::package_received=0;
    GlobalParams::stop_cycle = readParam<int>(config,"stop_cycle", INT_MAX);
