...
#define TRAFFIC_PERMUTATION    "TRAFFIC_PERMUTATION"
...
struct GlobalParams {
    ...
    static int my_topology;
    static int package_injected;
    static int package_received;
    static int stop_cycle;
};
