...
void GlobalStats::showStats(std::ostream & out, bool detailed)
{
    ...
    out << "% Received/Ideal flits Ratio: " << getReceivedIdealFlitRatio2() << endl;
...
// Warm up also counted!
double GlobalStats::getReceivedIdealFlitRatio2()
{
    int total_cycles;
    total_cycles= GlobalParams::simulation_time - GlobalParams::stats_warm_up_time;
	// cout<<"INjected: " << GlobalParams::package_received << " Received: " << GlobalParams::package_injected << endl;
    double ratio = (double)GlobalParams::package_received / GlobalParams::package_injected;
    return ratio;
}
